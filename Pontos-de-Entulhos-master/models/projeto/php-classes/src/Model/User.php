...
class User extends Model {
	...
	public function updatePassword()
	{
		...
		$results = $sql->select("CALL sp_password_update(:iduser,:despassword)",array(
			":iduser"=>$this->getiduser(),
			":despassword" => User::getPasswordHash($this->getdespassword())
		));
...
public static function getForgot($email,$inadmin = true)
	...
	public static function getForgotAdmin($email,$inadmin = true)
	{
		$sql = new Sql();
		...
		else
		{
			...
			else
			{
				...
				$code = base64_encode($code);
					...
					$link = "http://www.pontos-entulhos.com.br/admin/forgot/reset?code=$code";
	...
	public static function validForgotDecryptAdmin($code)
	{
